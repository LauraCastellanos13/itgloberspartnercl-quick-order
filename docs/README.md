...
Este elemento custom hace una orden rápida ingresando el número de SKU de un producto

![Preview](../assets/image-quick-order.png)
### Paso 1 - Clonar

Para empezar, [clonar](https://github.com/LauraCastellanos13/itgloberspartnercl-quick-order) este reopositorio para iniciar con la configuración básica. 
...
```
{
  ...
  "version": "0.0.1",
  "title": "Quick order",
  "description": "Custom application makes a quick order by entering the SKU number of a product""
}
```
